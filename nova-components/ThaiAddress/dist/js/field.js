...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-thai-address', __webpack_require__(3));
  Vue.component('detail-thai-address', __webpack_require__(6));
  Vue.component('form-thai-address', __webpack_require__(9));
});
