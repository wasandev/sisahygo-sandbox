...
Nova.booting(function (Vue, router, store) {
  Vue.component('loading', __webpack_require__(2));
});
        ...
        _c("card", [
          _c(
            ...
            [
              _c(
                "div",
                { staticClass: "align-top w-1/2 border-b border-r border-50" },
                [
                  _c(
                    "router-link",
                    {
                      staticClass: "no-underline dim flex p-6 w-full",
                      attrs: {
                        to: {
                          name: "create",
                          params: {
                    ...
                    "router-link",
                    {
                      ...
                      attrs: {
                        to: {
                          name: "index",
                          params: {
                            resourceName: "order_loaders"
                          }
                        },
                        title: _vm.จัดขึ้นสินค้า
                      }
                    },
                    [
                      _c(
                            ...
                            [
                              _c("path", {
                                attrs: {
                                  fill: "var(--primary)",
                                  d:
                                    "M4 10c0-1.1.9-2 2-2h8c1.1 0 2 .9 2 2v8c0 1.1-.9 2-2 2H6c-1.1 0-2-.9-2-2v-8zm2 0v8h8v-8h-2V8H8v2H6zm3-6.17V16h2V3.83l3.07 3.07 1.42-1.41L10 0l-.7.7L4.5 5.5l1.42 1.4L9 3.84z"
                                }
                              })
                            ]
                          )
