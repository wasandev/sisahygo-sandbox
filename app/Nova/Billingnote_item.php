...
class Billingnote_item extends Resource
{
     ...
     * @var string
     */
    public static $model = \App\Models\Billingnote_item::class;
    ...
    public static function relatableInvoices(NovaRequest $request, $query)
    {
