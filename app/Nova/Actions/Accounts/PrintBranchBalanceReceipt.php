...
class PrintBranchBalanceReceipt extends Action
{
    ...
    {
        return 'print-branch-balance-receipt';
    }
    /**
    ...
    public function handle(ActionFields $fields, Collection $models)
    {
        ...
        return Action::openInNewTab('/ar/report_21/' . $branch_value . '/' . $from_value . '/' . $to_value);
    }
