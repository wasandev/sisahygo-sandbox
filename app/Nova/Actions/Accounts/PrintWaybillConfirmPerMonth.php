...
class PrintWaybillConfirmPerMonth extends Action
{
    ...
    {
        return 'account-print-waybill-confirm-per-month';
    }
    ...
    public function handle(ActionFields $fields, Collection $models)
    {
        ...
        return Action::openInNewTab('/waybill/report_w1/' . $routetobranch_value . '/' . $from_value . '/' . $to_value);
    }
