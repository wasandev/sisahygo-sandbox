<div class="space-y-4">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-labelledby="search"
        role="presentation" class="fill-current absolute  ml-3 mt-6 text-gray_200">
    ...
    <div>
        ...
        @else
            @if ($order_statuses->isNotEmpty())
                เลขที่ใบรับส่งสินค้า : {{ $order_statuses->first()->order_header->order_header_no }}/Ref ID :
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M7 11.5V14m0-2.5v-6a1.5 1.5 0 113 0m-3 6a1.5 1.5 0 00-3 0v2a7.5 7.5 0 0015 0v-5a1.5 1.5 0 00-3 0m-6-3V11m0-5.5v-1a1.5 1.5 0 013 0v1m0 0V11m0-5.5a1.5 1.5 0 013 0v3m0 0V11" />
                        ...
                        <tbody class="bg-white dark:bg-slate-800">
                            ...
                            <tr>
                                ...
                                <td
                                    class="inline-flex border-b border-slate-100 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">
                                    {!! $icon !!} {{ $status }}
                                </td>
