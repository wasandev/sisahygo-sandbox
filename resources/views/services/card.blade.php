<div class="grid gap-4 grid-cols-2  lg:grid-cols-4 py-8 ">
    ...
    <div>
        <a href="/order-tracking"
            ...
            <p class="text-base  text-center text-gray-800  hover:text-white  p-2 ">ติดตามสินค้า</p>
    ...
    <div>
        <a href="/service-area"
            ...
            <p class="text-base  text-center text-gray-800  hover:text-white p-2 ">สอบถามพื้นที่บริการ</p>
    ...
    <div>
        <a href="/service-price"
            ...
            <p class="text-base  text-center text-gray-800  hover:text-white p-2 ">ค่าขนส่งสินค้า</p>
