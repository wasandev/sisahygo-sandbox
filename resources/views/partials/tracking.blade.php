...
<div  class="max-w-full mx-auto bg-blue-300">
    <form action="/tracking" method="POST" role="search">
        ...
        <div class="mx-auto">
            <div class="flex w-full p-4 md:p-4 text-2xl">
                ...
                class=" w-full transition-colors duration-100 ease-in-out focus:outline-none focus:shadow-md border border-transparent focus:bg-white  placeholder-gray-600 rounded-lg bg-gray-100 py-2 pr-2 pl-10  appearance-none leading-normal ">
