...
SISAHYGO : Application for Transportation Management
...
**SISAHYGO** จัดประเภทเมนูการทำงานเป็นงานด้านต่างๆ เพื่อง่ายต่อการทำงาน ได้แก่

-   **Dashboard**
    -   แสดงข้อมูลต่างในรูปแบบ Metrics ที่สามารถดูข้อมูลสรุป ได้ตามช่วงเวลาที่ต้องการ โดยแสดงเป็น 3 ประเภท ได้แก่
        -   Value Metrics
        -   Trend Metrics
        -   Patition Metrics
-   **งานสำหรับผู้ดูแลระบบ**
    -   สำหรับการกำหนดค่าระบบต่างๆ ในการเริ่มใช้ Aplication โดยผู้ดูแลระบบจะต้องกำหนดข้อมูลต่างๆ ได้แก่
        -   ข้อมูลบริษัท
        -   ข้อมูลสาขา
        -   ข้อมูลผู้ใช้
        -   สิทธิ์การใช้
